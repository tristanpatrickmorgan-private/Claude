# Övriga upplysningar — Swedish 2025 INK1

Three blocks to fill in on the "Övriga upplysningar" tab of the Skatteverket e-tjänst.

## 1. Utländska inkomster (structured table)

| Typ av inkomst | Land | Inkomst i SEK |
|---|---|---:|
| Kapital | Storbritannien | 310,434 |
| Kapital | Storbritannien | 2,730 |
| Kapital | Storbritannien | 150,150 |

(UK rental Box 7.3 / HSBC interest portion of Box 7.2 / Vanguard ISA gain Box 7.4. All gross SEK.)

## 2. Avräkning utländsk skatt

Enter: **SEK 5,608**

Working:
- UK 25/26 net tax: GBP 214 (SA ref 2605755020, submitted 19 May 2026)
- UK 24/25 net tax: GBP 1,092 (finalised)
